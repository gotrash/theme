## How does GoTrash Theme's test suite work?

GoTrash Theme uses [Jasmine](https://jasmine.github.io/). Each plugin has a file dedicated to its tests in `tests/unit/<plugin-name>.spec.js`.
...
- Each test should follow the project's [JavaScript Code Guidelines](https://github.com/gotrash/theme/blob/main/.github/CONTRIBUTING.md#js)
